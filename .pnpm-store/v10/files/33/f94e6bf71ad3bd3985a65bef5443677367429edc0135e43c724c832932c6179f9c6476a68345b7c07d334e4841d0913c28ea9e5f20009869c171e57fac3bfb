...
export { b as betterAuth } from './shared/better-auth.DAAngkks.mjs';
export { c as capitalizeFirstLetter } from './shared/better-auth.D-2CmEwz.mjs';
export { H as HIDE_METADATA, g as generateState, p as parseState } from './shared/better-auth.DsdWyrAx.mjs';
...
import './shared/better-auth.PiwIJPXr.mjs';
