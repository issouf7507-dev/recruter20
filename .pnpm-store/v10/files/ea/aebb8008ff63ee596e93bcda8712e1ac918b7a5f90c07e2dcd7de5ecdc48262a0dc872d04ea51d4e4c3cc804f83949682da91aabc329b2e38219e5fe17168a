...
const organization = require('../shared/better-auth.MpciKSoe.cjs');
...
const toAuthEndpoints = require('../shared/better-auth.BwmyuaDr.cjs');
...
const admin = require('../shared/better-auth.Cx-Pq1rN.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.DAEhyVbZ.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.6_2C44mS.cjs');
...
require('../shared/better-auth.BZVk4_ZS.cjs');
